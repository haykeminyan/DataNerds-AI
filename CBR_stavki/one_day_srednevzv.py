...
import schedule
import time
logging.basicConfig(filename="one_day_srednevz.log", format='%(asctime)s - %(message)s',
...
href_addr_current_date = 'http://www.cbr.ru/hd_base/mkr/mkr_base/?UniDbQuery.Posted=True&UniDbQuery.st=SF&UniDbQuery.ob=OB_MIACR_0&UniDbQuery.Currency=-1&UniDbQuery.sk=Dd1_&UniDbQuery.FromDate=' + \
