...
href_addr='http://www.cbr.ru/hd_base/metall/metall_base_new/?UniDbQuery.Posted=True&UniDbQuery.Gold=true&UniDbQuery.Silver=true&UniDbQuery.Platinum=true&UniDbQuery.Palladium=true&UniDbQuery.FromDate='+str(current_date)+'&UniDbQuery.ToDate='+str(current_date)
print(href_addr)
