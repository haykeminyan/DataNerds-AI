...
logging.basicConfig(filename="one_day_oboroty.log",format='%(asctime)s - %(message)s',datefmt='%d-%b-%y %H:%M:%S',filemode='w', level=logging.INFO)
...
folder_name='current_day_Обороты операций по кредитам в рублях, предоставленным московскими банками'
